...
This plot helps us confirm that there are no uneven densities in the different genders and learning typessupporting the normality of each variable. Still we can see outliers in the lower tail of **attitude** M, **deep** F, and **deep** M. We will keep this in mind when we move to the diagnostic plots. 
